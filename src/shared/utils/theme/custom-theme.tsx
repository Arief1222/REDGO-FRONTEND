const customTheme = {
  button: {
    ...
    outline: {
      color: {
        primary: "border border-primary dark:border-primary",
        secondary: "border border-secondary dark:border-secondary",
        success: "border border-success dark:border-success",
        info: "border border-info dark:border-info",
        warning: "border border-warning dark:border-warning",
        error: "border border-error dark:border-error",
        white: "border border-white dark:border-white",
        dark: "border border-dark dark:border-white",
        default: "border-0",
      },
      off: "",
  ...
  card: {
    root: {
      ...
      children: "flex h-full flex-col justify-center gap-2 p-0 flex-1",
    },
  },
