...
export default function EngineSubModeSelector({ selectedTopic, onSubModeSelect, onBack }: Props) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* ANALYSIS Card - hanya tampil jika topic punya analysis */}
        {showAnalysis && (
          <button
          ...
          >
            ...
            <p className="text-gray-600 mb-4">Evaluasi dan perbaikan strategi yang sudah berjalan</p>
            <ul className="space-y-2 text-sm text-gray-600">
              <li className="flex items-start gap-2">
