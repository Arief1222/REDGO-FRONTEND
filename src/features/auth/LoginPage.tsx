...
const StepEmailForm = ({ onBack }: { onBack: () => void }) => (
  <div style={{ animation: "fadeUp 0.35s ease both" }}>
    ...
    <style>{`
      ...
      .redgo-form-wrap input,
      .redgo-form-wrap .MuiInputBase-root {
      ...
      .redgo-form-wrap input:focus {
        background: #fff !important;
        border-color: #e53e3e !important;
        box-shadow: 0 0 0 4px rgba(229,62,62,0.07) !important;
        outline: none !important;
      }
      .redgo-form-wrap label,
      .redgo-form-wrap .MuiFormLabel-root {
        color: #9ca3af !important;
        font-size: 13px !important;
        font-weight: 500 !important;
      }
      .redgo-form-wrap button[type="submit"],
      .redgo-form-wrap .MuiButton-containedPrimary {
      ...
      .redgo-form-wrap button[type="submit"]:hover {
        background: #c53030 !important;
        transform: translateY(-1px) !important;
        box-shadow: 0 8px 28px rgba(229,62,62,0.38) !important;
      }
      .redgo-form-wrap .MuiFormControl-root { margin-bottom: 0 !important; }
      .redgo-form-wrap a { color: #e53e3e !important; font-weight: 600 !important; }
    `}</style>

    <div className="redgo-form-wrap">
      <AuthLogin />
    </div>
  </div>
)
